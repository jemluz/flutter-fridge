  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      actions: [
        ...
        TextButton(onPressed: () => _submitForm(), child: Text('Confirmar')),
      ],
          ...
          child: Column(
            children: <Widget>[
              ...
              TextInput(
                ...
                ctrl: _amountCtrl,
                onSaved: (value) => __addProductFormData['amount'] = int.parse(value),
                onValidation: (value) => Validation.amountValidation(value),
              ...
              TextInput(
                  ...
                  onSaved: (value) => __addProductFormData['imgSrc'] = value,
                  onValidation: (value) => Validation.imgSrcValidation(value)),
            ],
          ),
        ),
      ),
